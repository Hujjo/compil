...
import jtiger.bind.Binder;
import jtiger.bind.Escapes;
import jtiger.bind.TypeChecker;
...
public class Control {
    ...
    public void bind() {
        ...
        Errors.dieIfErrors(Errors.BIND_ERR);
    }

	/*
	 * Calls the type checker
     */
    public void typeCheck() {
        ast.acceptVisitor(new AstTraverse(new TypeChecker()));
        Errors.dieIfErrors(Errors.TYPE_ERR);
    }
}
