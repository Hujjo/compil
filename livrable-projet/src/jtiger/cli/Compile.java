...
public class Compile {
	...
	public static void main(String args[]) {
		...
		optionGroup.addOption(OptionBuilder.withLongOpt("binding")
				.withDescription("bind and dump decorated ast").create("b"));
		optionGroup.addOption(OptionBuilder.withLongOpt("typecheck")
				.withDescription("typecheck and dump decorated ast")
				.create("t"));
		...
		try {
			...
			formatter.printHelp("jtiger {-s|-p|-b|-t} input.tig", options);
